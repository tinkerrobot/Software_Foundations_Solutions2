...
Proof.
  ...
  apply trans_eq with m. apply H2. apply H1.
Qed.
...
Proof.
  intros n m H.
  rewrite <- double_plus in H. rewrite <- double_plus in H.
...
Lemma length_simpl : forall (X:Type) (l1 l2 :list X) (x : X),
...
Proof.
  ...
  - simpl. intros n H. rewrite -> length_simpl. induction n as [| n'].
    + inversion H.
    + inversion H. rewrite H1. apply IHl' in H1.
      simpl. rewrite H1. rewrite plus_n_Sm. reflexivity.
Qed.
...
Theorem double_induction: forall (P : nat -> nat -> Prop),
  ...
  forall m n, P m n.
Proof.
  intros P H H0 H1 H2 m n. generalize dependent m. induction n as [| n'].
